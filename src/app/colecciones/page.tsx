        ...
        {collections.map((col) => (
          <Reveal key={col.slug} blur={false}>
            ...
            >
              ...
              {/* scrim/onmedia y no ink/paper: sobre fotografía esos tokens
                  cambian con el tema del admin y acá quedaban invertidos. */}
              <div className="absolute inset-0 bg-gradient-to-t from-scrim/80 via-scrim/25 to-transparent" />
              <div
                className={cn(
              ...
              >
                <div className={cn("flex flex-col gap-3", col.align === "right" && "items-end")}>
                  ...
                  <p className="max-w-sm text-sm text-onmedia/85">{col.subtitle}</p>
