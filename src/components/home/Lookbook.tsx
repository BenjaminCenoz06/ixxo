            ...
            <div className="group relative h-full min-h-[300px] overflow-hidden bg-smoke">
              ...
              <div className="absolute inset-x-6 bottom-6 flex items-center justify-between text-onmedia">
                ...
                <Link
                  ...
                  className="flex translate-y-2 items-center gap-2 bg-onmedia px-4 py-2.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-scrim opacity-0 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-y-0 group-hover:opacity-100"
                >
