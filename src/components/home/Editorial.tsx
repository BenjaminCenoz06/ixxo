...
export default function Editorial() {
  ...
  return (
    <section className="relative flex min-h-[80vh] items-center overflow-hidden bg-scrim text-onmedia">
      ...
      <div className="container-ixxo relative py-28 text-center">
        <Reveal>
          <p className="eyebrow mb-6 text-onmedia/60">{c.eyebrow}</p>
        </Reveal>
        <Reveal delay={0.1}>
        ...
        <Reveal delay={0.2}>
          <p className="mx-auto mt-8 max-w-md text-sm leading-relaxed text-onmedia/70">{c.subtext}</p>
        </Reveal>
      </div>
    </section>
  );
